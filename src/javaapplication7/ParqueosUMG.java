...
public class ParqueosUMG extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Parqueos UMG");
        jLabel1.setSize(new java.awt.Dimension(45, 20));

        panel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel3.setText("Ver disponibilidad de parqueos");

        jButton1.setText("Ver");
        jButton1.setToolTipText("");

        jLabel2.setText("Esta opcion permite visualizar cuantos");

        jLabel4.setText("parqueos se encuentran ocupados o libres.");
        ...
        jLabel5.setText("Nueva reservación de parqueo");

        jLabel6.setText("Esta opcion permite reservar un nuevo ");

        jLabel7.setText("permitiendo generar el ticket.");
